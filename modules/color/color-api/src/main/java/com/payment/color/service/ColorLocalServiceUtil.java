...
public class ColorLocalServiceUtil {
	 ...
	 */
	public static com.payment.color.model.Color addColor(
	 ...
	 */
	public static com.payment.color.model.Color createColor(long colorId) {
	 ...
	 */
	public static com.payment.color.model.Color deleteColor(
		com.payment.color.model.Color color) {
	 ...
	 */
	public static com.payment.color.model.Color deleteColor(long colorId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static com.payment.color.model.Color fetchColor(long colorId) {
	 ...
	 * @throws PortalException if a color with the primary key could not be found
	 */
	public static com.payment.color.model.Color getColor(long colorId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<com.payment.color.model.Color> getColors(
		int start, int end) {
	 ...
	 */
	public static com.payment.color.model.Color updateColor(
		com.payment.color.model.Color color) {
