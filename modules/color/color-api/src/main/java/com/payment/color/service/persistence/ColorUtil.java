...
package com.payment.color.service.persistence;
...
public class ColorUtil {
	...
	public static Color findByUuid_First(
		...
		throws com.payment.color.exception.NoSuchColorException {
